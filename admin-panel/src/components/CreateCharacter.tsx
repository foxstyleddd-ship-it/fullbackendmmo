...
export default function CreateCharacter() {
  ...
  const houses = [
    { value: 'gryffindor', label: 'Gryffindor', color: 'text-red-700' },
    { value: 'slytherin', label: 'Slytherin', color: 'text-green-700' },
    { value: 'hufflepuff', label: 'Hufflepuff', color: 'text-yellow-700' },
    { value: 'ravenclaw', label: 'Ravenclaw', color: 'text-blue-700' },
  ];
